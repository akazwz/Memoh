...
import { computed, ref, watch, onMounted, toValue, nextTick, type Ref } from 'vue'
...
const searchIndex = computed(() => {
  return [
    ...
    { tab: 'apps', key: 'bots.tabs.apps', keywords: ['codex', 'claude code', 'opencode', 'node', 'python', 'uv', 'install', 'version', 'connector', 'oauth', 'dependency', 'supermarket', '依赖', '安装', '版本', '连接器', '扩展包', '依存', 'インストール', 'コネクター', 'パッケージ'] },
    ...
    { tab: 'agents', key: 'bots.tabs.agents', keywords: ['codex', 'claude code', 'opencode', 'external agent', 'acp'] },
