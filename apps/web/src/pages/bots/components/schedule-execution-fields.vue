...
import { isDirectBotAgentRuntime, botAgentName, botAgentProvider, normalizeBotAgentRuntime } from '@/utils/bot-agent'
...
function sessionRuntimeForAgent(agent: BotagentsBotAgent | undefined): 'acp_agent' | 'codex' | 'claude-code' | 'grok' {
