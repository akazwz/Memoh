...
import { isDirectBotAgentRuntime, botAgentIcon, botAgentName, botAgentProvider, isDirectBotAgentConfigured, normalizeBotAgentRuntime } from '@/utils/bot-agent'
...
function setDefaultAgent(value: string) {
  ...
  const direct = isDirectBotAgentRuntime(runtime)
  // eslint-disable-next-line vue/no-mutating-props
