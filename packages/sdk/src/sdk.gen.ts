 ...
 *
 * Returns UI-facing slash command manifests for the current bot/session/scope.
 */
export const getCommands = <ThrowOnError extends boolean = false>(options?: Options<GetCommandsData, ThrowOnError>) => (options?.client ?? client).get<GetCommandsResponses, GetCommandsErrors, ThrowOnError>({ url: '/commands', ...options });
