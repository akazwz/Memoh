 ...
 */
export const postBotsByBotIdSessionsBySessionIdAcpRuntimeAbortTurn = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdSessionsBySessionIdAcpRuntimeAbortTurnData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdSessionsBySessionIdAcpRuntimeAbortTurnResponses, PostBotsByBotIdSessionsBySessionIdAcpRuntimeAbortTurnErrors, ThrowOnError>({
 ...
 */
export const getBotsByBotIdSessionsBySessionIdAcpRuntimeTurn = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdSessionsBySessionIdAcpRuntimeTurnData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdSessionsBySessionIdAcpRuntimeTurnResponses, GetBotsByBotIdSessionsBySessionIdAcpRuntimeTurnErrors, ThrowOnError>({ url: '/bots/{bot_id}/sessions/{session_id}/acp-runtime/turn', ...options });
