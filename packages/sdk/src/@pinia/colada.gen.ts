 ...
 */
export const getCommandsQuery = defineQueryOptions((options?: Options<GetCommandsData>) => ({
    key: getCommandsQueryKey(options),
    query: async (context) => {
