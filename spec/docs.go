        ...
        "/bots/{bot_id}/agents/{id}/models": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Runtime collaboration mode for effective defaults",
    ...
    "definitions": {
        ...
        "external.ModelOption": {
            ...
            "properties": {
                ...
                "resolved_default_reasoning_effort": {
                    "description": "Display-only resolution of the inherited choice. Never persist this as\nthe user's preference: \"default\" must keep following runtime settings.",
                    "type": "string"
                },
                "resolved_model_id": {
